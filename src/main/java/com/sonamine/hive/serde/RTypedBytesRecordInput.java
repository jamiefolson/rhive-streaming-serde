...
public class RTypedBytesRecordInput implements RecordInput {
  ...
  private RTypedBytesRecordInput() {
  }
  ...
  private static ThreadLocal tbIn = new ThreadLocal() {
    ...
    protected synchronized Object initialValue() {
      return new RTypedBytesRecordInput();
    }
  };
   ...
   *         {@link TypedBytesInput}.
   */
  public static RTypedBytesRecordInput get(RTypedBytesInput in) {
    RTypedBytesRecordInput bin = (RTypedBytesRecordInput) tbIn.get();
   ...
   *         {@link DataInput}.
   */
  public static RTypedBytesRecordInput get(DataInput in) {
    return get(RTypedBytesInput.get(in));
  }

  /** Creates a new instance of TypedBytesRecordInput. */
  public RTypedBytesRecordInput(RTypedBytesInput in) {
    this.in = in;
  }

  /** Creates a new instance of TypedBytesRecordInput. */
  public RTypedBytesRecordInput(DataInput in) {
    this(new RTypedBytesInput(in));
  }
