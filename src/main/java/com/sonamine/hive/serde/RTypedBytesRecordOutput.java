...
public class RTypedBytesRecordOutput implements RecordOutput {
  ...
  private RTypedBytesRecordOutput() {
  }
  ...
  private static ThreadLocal tbOut = new ThreadLocal() {
    ...
    protected synchronized Object initialValue() {
      return new RTypedBytesRecordOutput();
    }
  };
   ...
   *         {@link TypedBytesOutput}.
   */
  public static RTypedBytesRecordOutput get(RTypedBytesOutput out) {
    RTypedBytesRecordOutput bout = (RTypedBytesRecordOutput) tbOut.get();
   ...
   *         {@link DataOutput}.
   */
  public static RTypedBytesRecordOutput get(DataOutput out) {
    return get(RTypedBytesOutput.get(out));
  }

  /** Creates a new instance of TypedBytesRecordOutput. */
  public RTypedBytesRecordOutput(RTypedBytesOutput out) {
    this.out = out;
  }

  /** Creates a new instance of TypedBytesRecordOutput. */
  public RTypedBytesRecordOutput(DataOutput out) {
    this(new RTypedBytesOutput(out));
  }
